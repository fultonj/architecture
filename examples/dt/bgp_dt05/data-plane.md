...
Shared EDPM defaults (SSH key placeholders, EVPN/FRR ansible vars, network
config template, and services lists) live under
[`examples/dt/bgp/common`](../bgp/common/) (`edpm-compute-evpn` /
`edpm-networker-evpn`). Edit them if you need to change those defaults for
all racks:

- [../bgp/common/edpm-compute-evpn/edpm-nodeset-values.yaml](../bgp/common/edpm-compute-evpn/edpm-nodeset-values.yaml)
- [../bgp/common/edpm-networker-evpn/edpm-nodeset-values.yaml](../bgp/common/edpm-networker-evpn/edpm-nodeset-values.yaml)
